...
# 將對接好的 gestalt_engine.py 寫入 core 目錄
gestalt_code = """
...
with open("core/gestalt_engine.py", "w", encoding="utf-8") as f:
    f.write(gestalt_code.strip())

print("core/gestalt_engine.py 與 MemoryManager 對接完成！")
